...
Match2Data <- read.csv("Mtl-Ott-game2.csv")
attach(Match2Data)
...
#Prob_Field[which(Prob_Field > 26)] = 0.01
...
layout <- list(
  title = "Shot Location Match 2 Habs", 
  xaxis = list(
    title = "X Coordinate", 
    range = c(0, 200),
    showgrid = FALSE, 
...
response <- py$plotly(data, kwargs=list(layout=layout, filename="ShotLocationHabsONNETMatch2"))
url <- response$url
...
layout <- list(
  title = "Shot Location Match 2 Senators", 
  xaxis = list(
    title = "X Coordinate", 
    range = c(0, 200),
    showgrid = FALSE, 
...
response <- py$plotly(data, kwargs=list(layout=layout, filename="ShotLocationSenatorMatch2sONNET"))
url <- response$url

####
colShotsHabsRGBONNET = rgb(colShotsHabsONNET[,])
png("Shots_Habs2ONNET3.png")
plot(xCoordNormShotHabsONNET, yCoordNormShotHabsONNET, col=colShotsHabsRGBONNET, pch=19, cex=3, xlim = c(0,200), ylim=c(0,168))
dev.off()

colShotsSenatorsRGBONNET = rgb(colShotsSenatorsONNET[,])
png("Shots_Senators2ONNET3.png")
